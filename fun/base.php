...
define('_PRIORITY_ERROR',    LOG_ERR);
...
function _getDebugLevel($lvStr = '') 
{
    ...
    if (defined('_DLV_' . strtoupper($lvStr)))
    {
        return constant('_DLV_' . strtoupper($lvStr));
    }
 ...
 */
function _syslogRegister($logSettingStr = 'local6.debug', $logRKey = null, $logTag = null) 
{
